<%@ Page Language="C#" AutoEventWireup="true" CodeFile="setQiangji2.aspx.cs" Inherits="QiangJiAdmin_Qiangji2" %>
...
<body>
   ...
   PagerStyle-CssClass="pgr"   BackColor="White" 
        ...
        &nbsp;强基产品类：<asp:DropDownList  CssClass="inputLB" Width="200px"  ID="hangye" runat="server" AutoPostBack="True" OnSelectedIndexChanged="hangye_SelectedIndexChanged"></asp:DropDownList>
   ...
   PagerStyle-CssClass="pgr" >
                        ...
                        <Columns>                           
                            ...
                            <asp:BoundField DataField="name" HeaderText="参数名称"  ItemStyle-Width="300px"/>
                            <asp:BoundField DataField="Description" HeaderText="描述" ItemStyle-Width="360px" />
                         
                           
                            <asp:CommandField HeaderText="编辑" ShowEditButton="True"  ItemStyle-Width="50px" >
