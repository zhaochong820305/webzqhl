<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qiangji.aspx.cs" Inherits="admin_qiangji" %>
        ...
        <div style="float: left; height: 500px; margin-top: 30px; line-height: 40px; width: 95%; margin-left: 19px;">
            <table border="0" style="width: 100%; height: 10%; padding: inherit; margin: 0 auto; border: thin solid #eac998;">
                <tr>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;展示产品：
                    <asp:GridView ID="GridView1" Width="925px" Height="100%" runat="server"
                            CssClass="mGrid"
                            ...
                            <Columns>
                                <asp:BoundField DataField="RNO" HeaderText="编号">
                             ...
                             <%--   <asp:BoundField DataField="YYQKName" HeaderText="应用情况" />
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        ...
                                        <a href="qiangjiedit.aspx?id=<%# Eval("ID") %>&p=<%=PgIndex %>" target="_blank">编辑</a>
