<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ziyuan.aspx.cs" Inherits="admin_ziyuan" %>
<!DOCTYPE html>
...
<body>
   ...
   <div id="tab1" class="taba" style="display:block;width:100%;">
        ...
        <div style="height:60px;width:100%">&nbsp;&nbsp;&nbsp;&nbsp;标题：<asp:TextBox ID="title" Width="200px" CssClass="inputLB" runat="server"></asp:TextBox>
            ...
            &nbsp;<asp:Button ID="new" CssClass="buttonLB" runat="server" Text="添加资源" OnClick="new_Click" />
        </div>
            ...
            AutoGenerateColumns="False" PageSize="14" OnPageIndexChanging="myGrid_PageIndexChanging" 
                      ShowHeaderWhenEmpty="True" OnRowDataBound="myGrid_RowDataBound">
                        ...
                        <%--    <asp:BoundField DataField="hobby" HeaderText="分类" />--%>
                            <asp:BoundField DataField="update" HeaderText="发布时间"  DataFormatString="{0:yyyy-MM-dd}" />
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <asp:LinkButton ID="bj" runat="server" CommandArgument='<%# Eval("ID") %>' OnCommand="bj_Command">编辑</asp:LinkButton>
                                    &nbsp;<asp:LinkButton ID="sc" runat="server" CommandArgument='<%# Eval("ID") %>' OnClientClick="if(confirm(&quot;确定要删除该资源库么?&quot;)==false)return false;" OnCommand="sc_Command">删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
