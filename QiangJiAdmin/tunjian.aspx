<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tunjian.aspx.cs" Inherits="admin_tunjian" %>
...
<body>
   ...
   PagerStyle-CssClass="pgr"   BackColor="White" 
        ...
        &nbsp;添加: 推荐人名称：<asp:TextBox CssClass="inputLB" ID="TextBox1" runat="server" Width="100px" Height="30px"></asp:TextBox>
        推荐人电话： <asp:TextBox CssClass="inputLB" ID="TextBox2" runat="server" Width="100px" Height="30px"></asp:TextBox>
   ...
   PagerStyle-CssClass="pgr" >
                        ...
                        <Columns>                           
                            ...
                            <asp:BoundField DataField="ID" HeaderText="参数值"  ItemStyle-Width="80px"  ReadOnly="True"/>
                            <asp:BoundField DataField="name" HeaderText="推荐人姓名"  ItemStyle-Width="100px"/>
                            <asp:BoundField DataField="Mobile" HeaderText="电话" ItemStyle-Width="500px" />
