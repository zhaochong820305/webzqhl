<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gongye.aspx.cs" Inherits="admin_gongye" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="height: 80px; width: 100%; padding-left:20px;">
            十大领域：<asp:DropDownList CssClass="inputLB" Width="150px" ID="ddlhangye" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlhangye_SelectedIndexChanged"></asp:DropDownList>
            
            <asp:DropDownList CssClass="inputLB" Width="150px" ID="ddlDiWei" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDiWei_SelectedIndexChanged" Visible="false"></asp:DropDownList>
            <%--&nbsp;&nbsp;选择企业：--%><asp:DropDownList  CssClass="inputLB" Width="150px"  ID="ddlCompany" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCompany_SelectedIndexChanged" Visible="false"></asp:DropDownList>
            十六 条龙：<asp:DropDownList ID="qianjisltl"  CssClass="inputLB"  runat="server"   Width="150px"></asp:DropDownList>
            ...
            <asp:DropDownList ID="LeiBie" runat="server"  CssClass="inputLB"   Width="150px"></asp:DropDownList>
            <br><%--首页位置:&nbsp;--%><%--<asp:CheckBox ID="indexview" runat="server" />--%>
            <asp:DropDownList ID="indexlocation" runat="server" Height="22px" Width="150px" Visible="false">
                        </asp:DropDownList>
            ...
            <%--合作企业:&nbsp;--%><asp:CheckBox ID="hezuo" runat="server" Visible="false" /> 
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="gongyeadd.aspx?id=0" class="buttonLB1" style="font-size:12px;line-height:20px;height:20px;display:inline-block; width:90px; " >添加强基产品</a> 
        ...
        <div style="float: left; height: 500px; margin-top: 30px; line-height: 40px; width: 95%; margin-left: 19px;">
            ...
            <table border="0" style="width: 100%; height: 10%; padding: inherit; margin: 0 auto; border: thin solid #eac998;">
                <tr>
                    ...
                    <asp:GridView ID="myGrid" Width="925px" Height="100%" runat="server"
                            ...
                            <Columns>
                                <asp:BoundField DataField="id" HeaderText="强基编号">
                                    <HeaderStyle Width="30px" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="强基名称" DataField="pname" />
                          
                                <asp:BoundField DataField="createtime" HeaderText="强基收录时间"  DataFormatString="{0:yy-MM-dd HH:mm}" />

                                <asp:TemplateField HeaderText="强基操作">
                                    <ItemTemplate>
                                       <%-- <a href="gongyelist.aspx?id=<%# Eval("ID") %>&p=<%=PgIndex %>">报表</a>--%>
                                        <a href="gongyeedit.aspx?id=<%# Eval("ID") %>&p=<%=PgIndex %>" target="_blank">编辑</a>
