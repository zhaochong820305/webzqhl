...
public partial class admin_Resultedit : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "";
        {
            ...
            + ",indexlocation='" + (indexlocation.SelectedValue) + "',hezuo='" + ((hezuo.Checked) ? "1" : "0") + "' ,[biaoqian]='" + biaoqian.Text + "' ,[zhongyao]='" + Common.strFilter(zhongyao.SelectedItem.Text) + "' ,[wanzheng]='" + Common.strFilter(wanzheng.SelectedItem.Text) + "'  where id=" + cid;
