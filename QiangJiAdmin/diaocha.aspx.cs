...
using System.Data;
public partial class admin_diaocha : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt;
        string sql = @"SELECT *,(case isIGBT WHEN '1' THEN 'IGBT领域' ELSE '其他领域' END) igbt  FROM  [company] where (1=1 ) and typeid='10' and (   state=1)";
