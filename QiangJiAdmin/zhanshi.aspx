<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhanshi.aspx.cs" Inherits="admin_zhanshi" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="height: 80px; width: 100%; padding-left:20px;">
            ...
            十六&nbsp;条龙：<asp:DropDownList ID="qianjisltl" runat="server" CssClass="inputLB" Width="150px"></asp:DropDownList>
            ...
            <asp:DropDownList ID="indexlocation" runat="server"  CssClass="inputLB"  Width="150px" Visible="false">
                        </asp:DropDownList>
