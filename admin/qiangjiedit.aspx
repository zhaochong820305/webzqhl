<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qiangjiedit.aspx.cs" Inherits="admin_qiangjiedit" %>
    ...
    <table class="gridtable"  <% if (typeid == 1) Response.Write("style='display: block'"); else Response.Write("style='display: none'"); %> id="list1">
           ...
           <%-- <tr style="page-break-inside: avoid;">   
            ...
            <tr style="page-break-inside: avoid;">
                ...
                <th class="auto-style3">工业强基十六条龙计划：</th>
                <td >
                    <asp:DropDownList ID="qianjisltl" runat="server" Height="22px" Width="246px">
                        </asp:DropDownList>
                </td>
            </tr>
            <%--<tr style="page-break-inside: avoid;">
            ...
            <tr style="page-break-inside: avoid;">
             ...
             <tr style="page-break-inside: avoid;">
                ...
                <th class="auto-style4">    展示产品            <label> </label></th>
                <td  colspan="3"> <asp:CheckBox ID="zhanshi" runat="server" /> </td>       
            </tr>
            <tr style="page-break-inside: avoid;">
