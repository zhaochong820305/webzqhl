<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mingpian.aspx.cs" Inherits="admin_mingpian" %>
...
<body>
    ...
    <div  style="float:left;height:500px;margin-top:30px;line-height:40px;width:100%;margin-left:20px;">
        <div  style="float:left;height:50px;margin-top:30px;line-height:40px;width:750px;">
            &nbsp;<asp:Button ID="new" CssClass="buttonLB" runat="server" Text="添加名片" OnClick="new_Click" /><br>
            ...
            所属业务员：<asp:DropDownList ID="yewu" runat="server" CssClass="inputLB"  Width="100px"></asp:DropDownList>
    ...
    <asp:GridView ID="myGrid" Width="900px" Height="100%" runat="server"
                       CssClass="mGrid"
            ...
            AutoGenerateColumns="False" PageSize="14" OnPageIndexChanging="myGrid_PageIndexChanging" 
                      ShowHeaderWhenEmpty="True" OnRowDataBound="myGrid_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="modtel" HeaderText="手机" />
                          <%--  <asp:BoundField DataField="email" HeaderText="电子邮箱" />--%>
                   <%--         <asp:BoundField DataField="title" HeaderText="职务" />--%>
                           <%-- <asp:BoundField DataField="update" HeaderText="更新时间" />--%>
                           
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <a href="mingpianadd.aspx?id=<%# Eval("ID") %>&op=kan" >报表</a>   
