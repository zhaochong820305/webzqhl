<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HangYe2.aspx.cs" Inherits="admin_HangYe2" %>
...
<body>
   ...
   PagerStyle-CssClass="pgr" >
                        ...
                        <Columns>                           
                            ...
                            <asp:BoundField DataField="ID" HeaderText="参数值"  ItemStyle-Width="20px"  ReadOnly="True"/>
