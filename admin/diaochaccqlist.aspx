<%@ Page Language="C#" AutoEventWireup="true" CodeFile="diaochaccqlist.aspx.cs" Inherits="admin_diaochaccqlist" %>
...
<body>
    ...
    <div>
        <div id="content">
        <div class="title">存储器一条龙申报提纲 <a href="diaochaccq.aspx">返回存储一条龙申报提纲 列表</a></div>
