    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                qiangji2.SelectedValue = dr["qiangji2"].ToString();
                BindZheng(cid);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "";
        {
            sql = @"UPDATE [dbo].[product]
                    ...
                    + "'     ,[qiangji] = '" + Common.strFilter(qiangji.Text) + "'  ,[qiangji2] = '" + Common.strFilter(qiangji2.Text) + "'     ,[dizhi] = '" + Common.strFilter(ddldizhi.Text) + "'                        ,[chanye] = '" + Common.strFilter(chanye.Text) 
