<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhengceaddnew.aspx.cs" Inherits="admin_zhengceaddnew" %>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <ul>
        ...
        <li><label class="labelblue">单位层级：</label>
            ...
            <asp:RadioButton ID="RadioButton6" runat="server" class="radio" Text="  国务院"  GroupName="jibei"/> 
            <asp:RadioButton ID="RadioButton7" runat="server" class="radio" Text="  国家部委"  GroupName="jibei"/> 
            <asp:RadioButton ID="RadioButton8" runat="server" class="radio" Text="  省级（及以下）" GroupName="jibei"/>
            <asp:RadioButton ID="RadioButton1" runat="server" class="radio" Text="  单列市" GroupName="jibei"/>（发文单位所属层级）
        </li>
