...
using System.Data;
public partial class QiangJiAdmin_Qiangji2 : System.Web.UI.Page
{
    ...
    {
        DataTable dt;
        string sql = @"SELECT   [ID]      ,[HangYeID]      ,[Name]      ,[Description]  FROM [dbo].[Qiangji2] where (state=1 or state is null) and  [HangYeID]=" + stype;
    ...
    {
        DBqiye.getRowsCount("update  [Qiangji2] set state=0 where id=" + e.CommandArgument);
        BindGrid();
    }
    ...
    protected void myGrid_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string sql = "update [Qiangji2] set[Name] = '" + name + "',[Description]='" + desc + "' where [ID]='" + id + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //    return;
        //}
        string sql = @"INSERT INTO [dbo].[Qiangji2] ([HangYeID]           ,[Name]           ,[Description]           ,[state])   VALUES
