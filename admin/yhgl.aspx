<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yhgl.aspx.cs" Inherits="admin_yhgl" %>
   ...
   <div id="tab1" class="taba" style="display:block;">
        ...
        <div style="float:left;height:500px;margin-top:0px;line-height:40px;width:1200px;">
            <table border="0" width="100%" height="700px" style="padding: inherit; margin: 0 auto; border: thin solid #eac998;">
                <tr><td style="vertical-align:top;background-color:#F7F7DE" width="50%">
   ...
   PagerStyle-CssClass="pgr"   BackColor="White" 
        ...
        ForeColor="Black" GridLines="Vertical" AllowPaging="True" 
            ...
            <ItemStyle CssClass="hidden" />
                            ...
                            <asp:BoundField HeaderText="用户名" DataField="loginuser" />
        ...
        <SortedDescendingHeaderStyle BackColor="#575357" />
                    ...
                    <td style="vertical-align:top"  width="48%">
                        ...
                        <li>
                            <label>登录名：</label>
                            <asp:TextBox ID="loginuser" runat="server"  class="inputLB" style="width:300px;"></asp:TextBox>
                            *</li>
                         <li>
                            <label>姓&nbsp;&nbsp;名：<b></b></label>
                            <asp:TextBox ID="xm" runat="server" class="inputLB" style="width:300px;"></asp:TextBox>
                        </li>
                            <li>
                            <label>密&nbsp;&nbsp;码：<b></b></label>
                            <asp:TextBox ID="pass" runat="server" TextMode="Password" class="inputLB" style="width:300px;"></asp:TextBox>
                        </li>
                            <li>默认密码为：123456，为空则不修改；</li>
                        <li><label>&nbsp;</label></li>
                        <li><label>&nbsp;</label>
                            <asp:Button ID="tj" class="buttonLB"  runat="server" Text="添加用户" Visible="true" OnClick="tj_Click" /> 
                            &nbsp;<asp:Button ID="bc" class="buttonLB"  runat="server" Text="保存用户" Visible="true" OnClick="bc_Click" /> 
                            </li>
                        </ul>
