...
using System.Data;
public partial class admin_zhengcelist : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt;
        string sql = @"SELECT  * from caijiset where state=1 ";
        ...
        if (sname.Text.Length > 0)
        {
            ...
            sql += " and (chinaname like '%" + sname.Text + "%' or classname like '%" + sname.Text + "%' )";
        }
    ...
    {
        DBZhengce.getRowsCount("update  caijiset set state=0 where id=" + e.CommandArgument);
        BindGrid();
    }
