...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server"></asp:ScriptManagerProxy>
            &nbsp;&nbsp;&nbsp;&nbsp;标题：<asp:TextBox ID="title" Width="150px" CssClass="inputLB" runat="server"></asp:TextBox>
<%--            &nbsp;分类：<asp:DropDownList  CssClass="inputLB" Width="150px"  ID="fl" runat="server"></asp:DropDownList>
            ...
            <asp:Button ID="new" CssClass="buttonLB" runat="server" Text="添加视频" OnClick="new_Click" />
               ...
               </table>--%> <asp:Label ID="msg" runat="server"  ForeColor="Red"></asp:Label> 
            ...
            <ItemStyle CssClass="hidden" Width="20px"  Height="30px"/>
                            ...
                            <ItemStyle Width="20px" />
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>                              
                                    <a href="videoadd.aspx?id=<%# Eval("ID") %>&op=edit" >编辑</a>
                                </ItemTemplate>
