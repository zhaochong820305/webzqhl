        ...
        <asp:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server"></asp:ScriptManagerProxy>
               ...
               <table class="gridtable" style="margin-left:10px;width:880px;">
                   <tr>
                        ...
                        <td style="vertical-align:top" >
                                <asp:TextBox ID="title" runat="server"  class="inputLB" value="2018年工博会精彩图片直播"  style="width:200px;"></asp:TextBox>
                   </tr>
                   <tr>
                       <th style="vertical-align:top" >
                       ...
                       <td style="vertical-align:top" >
                            <asp:TextBox ID="link" runat="server"  class="inputLB" value="http://www.niita.cn/gongbohui/qiangji.aspx"  style="width:200px;"></asp:TextBox>
                   </tr>
                   <tr>
                        <th style="vertical-align:top" >
                            <label>&nbsp;图&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;片：<b></b></label>
                   ...
                   <tr>
                       <th style="vertical-align:top" >
                            <label>&nbsp;是否发布：</label>
                       <td style="vertical-align:top" >
                            <asp:CheckBox ID="en" runat="server" Checked="true" />
