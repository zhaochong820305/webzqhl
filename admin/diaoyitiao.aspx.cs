...
using System.Data;
public partial class admin_diaoyitiao : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt;
        string sql = @"SELECT *,(case isIGBT WHEN '1' THEN 'IGBT领域' ELSE '其他领域' END) igbt  FROM  [company] where (1=1 ) and typeid='12' and (   state=1)";
