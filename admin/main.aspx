...
<body style="background:url(images/back.png) no-repeat 0 -100px; background-size:200%;">
<div id="headerc" >
    <form runat="server">
...
<div id="content">
    ...
    <div class="right">
        ...
        <div id="hosts" style="position:absolute;border-width:2px;height:2200px;width:1060px;left:170px;">
            <iframe src="content.aspx" frameborder="0" id="_content"  hspace="0" vspace="0"  scrolling="auto"  style="width:1040px;height:2200px;"></iframe>
        </div>
     </div>
</div>
