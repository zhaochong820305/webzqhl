...
using System.Data;
public partial class admin_HangYeZC2 : System.Web.UI.Page
{
    ...
    {
        DBZhengce.getRowsCount("update  [HangYe2] set state=0 where id=" + e.CommandArgument);
        BindGrid();
    }
