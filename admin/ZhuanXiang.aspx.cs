...
using System.Data;
public partial class admin_ZhuanXiang : System.Web.UI.Page
{
    ...
    {
        DataTable dt;
        string sql = @"SELECT   [ID]      ,[HangYeID]      ,[Name]      ,[Description]  FROM [dbo].[ZhuanXiang2] where (state=1 or state is null) and  [HangYeID]=" + stype;
    ...
    {
        DBZhengce.getRowsCount("update  [ZhuanXiang2] set state=0 where id=" + e.CommandArgument);
        BindGrid();
    }
