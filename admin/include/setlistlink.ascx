...
<a <% if (stype == "2") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=2">+&nbsp;所在地区</a>&nbsp; 
      ...
      <a <% if (stype == "44") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=44">+&nbsp;成果类别</a>&nbsp;
        <br />
        <br />
        ...
        <a <% if (stype == "45") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=45">+&nbsp;资源库类</a>&nbsp; 
        <br />
        <br />
        <a <% if (stype == "46") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=46">+&nbsp;视频分类</a>&nbsp; 
        <a <% if (stype == "51") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=51">+ 单位层级</a>&nbsp;
        <a <% if (stype == "49") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=49">+ 发文部委</a>&nbsp;
        <a <% if (stype == "50") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=50">+ 五大工程 </a>&nbsp;
        <a <% if (stype == "47") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setlist.aspx?type=47">十六条龙计划</a>&nbsp;        
        <a <% if (stype == "48") Response.Write("class='buttonLB1'"); else Response.Write("class='buttonLB1 button2'"); %> href="setQiangji2.aspx?type=48">子强基分类</a>&nbsp;
        <br />
        <br />
        <%--51--%>
